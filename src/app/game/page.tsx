    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        <Tabs defaultValue="game" className="flex-1 flex flex-col overflow-hidden">
          <div className="px-6 py-2 border-b bg-card/50 flex justify-center shrink-0">
            <TabsList>
          ...
          <div className="flex-1 relative overflow-hidden bg-background">
            <TabsContent value="game" className="h-full flex flex-col overflow-hidden p-0 m-0 data-[state=inactive]:hidden">
            ...
            <TabsContent value="reference" className="h-full overflow-y-auto p-6 m-0 bg-background/50 data-[state=inactive]:hidden">
